...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "172", version = "",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-172/blob/master/LICENSE.txt") ) )
  @Path("/")
   ...
   */
  @GET
  @Path("/mpath/{pathparam_name}")
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.TEXT_PLAIN)
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "res")
  })
  @ApiOperation(value = "mname", notes = " ")
  public Response mname(@PathParam("pathparam_name") String pathparam_name) {
    ...
    if(res_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity(rest.toJSONString()).build();
    }
    return null;
  }
